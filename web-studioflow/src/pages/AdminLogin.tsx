    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-md animate-float-up">
        ...
        <div className="rounded-3xl border border-border/70 bg-card p-8 shadow-lift">
          ...
          {error && (
            <div className="mt-6 rounded-xl bg-destructive/10 px-4 py-3 flex items-center gap-3">
          ...
          <div className="mt-6 space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-white py-3 text-sm font-medium text-foreground shadow-soft transition hover:bg-secondary disabled:opacity-60"
            >
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <span className="text-xs text-muted-foreground">studio owner access</span>
            <div className="h-px flex-1 bg-border" />
          </div>
