...
const terminology: Record<Vertical, VerticalTerminology> = {
  ...
  swimming: {
    ...
    classStyle: "Program Type",
    event: "Carnival",
    eventPlural: "Carnivals",
    verticalAdjective: "swimming",
    enabledModules: ["family", "classes", "schedule", "payments", "waivers", "instructors", "announcements"],
    styleSuggestions: ["Learn to Swim", "Squad", "Masters", "Stroke Correction", "Competition Prep", "Water Safety"],
    styleCategories: ["Learn to Swim", "Squad", "Masters", "Stroke Correction", "Competition Prep", "Water Safety"],
  },
  pilates: {
    participant: "Client",
    ...
    class: "Session",
    classPlural: "Sessions",
    classStyle: "Session Type",
    event: "Showcase",
    eventPlural: "Showcases",
    verticalAdjective: "Pilates",
    enabledModules: ["family", "classes", "schedule", "payments", "waivers", "instructors", "announcements"],
    styleSuggestions: ["Reformer", "Mat", "Clinical", "Barre", "Prenatal", "Beginner", "Advanced"],
    styleCategories: ["Reformer", "Mat", "Clinical", "Barre", "Prenatal", "Beginner", "Advanced"],
  },
  gymnastics: {
    participant: "Gymnast",
    participantPlural: "Gymnasts",
    guardian: "Guardian",
    guardianPlural: "Guardians",
    instructor: "Coach",
    instructorPlural: "Coaches",
    ...
    classStyle: "Program Type",
    event: "Display",
    eventPlural: "Displays",
    verticalAdjective: "gymnastics",
    enabledModules: ["family", "classes", "schedule", "costumes", "recitals", "payments", "waivers", "instructors", "announcements"],
    styleSuggestions: ["Recreational", "Competitive", "Acrobatics", "Tumbling", "Trampoline", "Pre-school", "WAG", "MAG"],
    styleCategories: ["Recreational", "Competitive", "Acrobatics", "Tumbling", "Trampoline", "Pre-school", "WAG", "MAG"],
  },
  cheer: {
    participant: "Athlete",
    ...
    event: "Competition",
    eventPlural: "Competitions",
    verticalAdjective: "cheer",
    enabledModules: ["family", "classes", "schedule", "costumes", "recitals", "payments", "waivers", "instructors", "announcements"],
    styleSuggestions: ["All Stars", "School Cheer", "Rec Cheer", "Tumbling", "Stunting", "Performance", "Junior", "Senior"],
    styleCategories: ["All Stars", "School Cheer", "Rec Cheer", "Tumbling", "Stunting", "Performance", "Junior", "Senior"],
  },
};
...
export const VERTICAL_LABELS: Record<Vertical, string> = {
  ...
  swimming: "Swimming School",
  pilates: "Pilates Studio",
  gymnastics: "Gymnastics Club",
  cheer: "Cheer Academy",
};
