...
export const IMPORT_TEMPLATES: ImportTemplate[] = [
  {
    ...
    columns: [
      ...
      { field: "parentName", label: "Parent / Guardian Name", required: false, description: "Primary parent or guardian", example: "Diane Walsh" },
      { field: "parentEmail", label: "Parent Email", required: true, description: "Email for communications and portal access", example: "diane@example.com" },
      { field: "parentPhone", label: "Parent Phone", required: false, description: "Best contact number", example: "(555) 123-4567" },
      { field: "parentAddress", label: "Parent Address", required: false, description: "Street address", example: "1428 NW Lovejoy St" },
